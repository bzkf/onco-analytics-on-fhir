...
```sh
curl -L -O https://github.com/bzkf/diz-in-a-box/releases/download/v1.6.1/air-gapped-installer.tgz
```
...
```sh
helm upgrade --install --wait --timeout=10m --version=1.6.1 prerequisites oci://ghcr.io/bzkf/diz-in-a-box/charts/prerequisites
...
```sh
helm upgrade --install --wait --timeout=10m --version=1.6.1 diz-in-a-box oci://ghcr.io/bzkf/diz-in-a-box/charts/diz-in-a-box
