...
FROM
    fhir_data
    FULL OUTER JOIN onkostar_data ON fhir_data."Year of Diagnosis" = onkostar_data."Year of Diagnosis"
    AND fhir_data.icd10_code = onkostar_data.icd10_code
    FULL OUTER JOIN csv_data ON COALESCE(
        fhir_data."Year of Diagnosis",
        onkostar_data."Year of Diagnosis"
    ) = csv_data."Year of Diagnosis"
